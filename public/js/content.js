...
{ key:'forest', name:"Whispering Forest", enemies:['slime','goblin','sprig','mudpup','thornling','mosshopper','bramblewolf','gladefly'], boss:'ent', bossName:"Elder Ent",
    ...
    { key:'hollow', name:"Mossy Hollow", enemies:['fungling','pixiemoth','bograt','willowisp','tangleroot','hollowstag'], boss:'hollowKing', bossName:"The Hollow King",
      ...
      bossAbilities:[ {type:'weakpoint', every:11000, duration:2500, bonusMult:2}, {type:'curse', every:15000, clicksNeeded:5} ] },
    { key:'cave', name:"Deep Cave", enemies:['bat','golem','caverat','gloomshroom','stalamite','tunnelworm','echobat','quartzcrab'], boss:'crystalGolem', bossName:"Crystal Golem",
      ...
      bossAbilities:[ {type:'shield', every:9000, duration:3000, reduction:0.85}, {type:'enrage', every:13000, duration:3500} ] },
    { key:'underdark', name:"Underdark Depths", enemies:['deepspider','gloomwraith','fungalhorror','blindstalker','cavetroll','voidmoth'], boss:'abyssalWarden', bossName:"The Abyssal Warden",
      ...
      bossAbilities:[ {type:'regen', every:9000, fraction:0.12, maxTicks:5, lowHpThreshold:0.3}, {type:'camouflage', every:12000, duration:2500} ] },
    { key:'frostpeak', name:"Frostpeak Foothills", enemies:['iceimp','frosthare','snowwolf','rimespider','glaciercrab','frostwisp'], boss:'frostWarden', bossName:"The Frost Warden",
      ...
      bossAbilities:[ {type:'frostbite', every:8000, duration:4000}, {type:'summon', every:14000, addKey:'rimespider', addHpFrac:0.22} ] },
    { key:'ruins', name:"Sundered Ruins", enemies:['rustbot','ruinwisp','animatedarmor','tombcrawler','archivist','gargoyle'], boss:'forgottenKing', bossName:"The Forgotten King",
      ...
      bossAbilities:[ {type:'summon', every:13000, addKey:'animatedarmor', addHpFrac:0.24}, {type:'curse', every:16000, clicksNeeded:6} ] },
    { key:'volcanic', name:"Volcanic Wastes", enemies:['emberimp','magmaslug','ashwraith','cinderhound','obsidiangolem','lavanewt'], boss:'cinderBaron', bossName:"The Cinder Baron",
      ...
      bossAbilities:[ {type:'drain', every:10000, duration:3500, drainFrac:0.4}, {type:'summon', every:14000, addKey:'cinderhound', addHpFrac:0.22} ] },
    { key:'fen', name:"Shadow Fen", enemies:['bogzombie','willothewisp','venomtoad','marshleech','rothag','plaguerat'], boss:'fenWitch', bossName:"The Fen Witch",
      ...
      bossAbilities:[ {type:'taunt', every:9000, duration:3000, missChance:0.4}, {type:'gamble', every:13000, duration:3000} ] },
    { key:'storm', name:"Storm Reaches", enemies:['stormsprite','cloudserpent','thunderhawk','galewisp','lightningelemental','skyjelly'], boss:'stormHerald', bossName:"The Storm Herald",
      ...
      bossAbilities:[ {type:'summon', every:13000, addKey:'thunderhawk', addHpFrac:0.24}, {type:'overcharge', every:15000, channelDuration:4000, healFrac:0.08} ] },
    ...
    { key:'peak', name:"Dragon's Peak", enemies:['skeleton','wyvern','boneknight','wyrmling','frostharpy','obsidianwyvern'], boss:'dragon', bossName:"Ancient Dragon",
      ...
      bossAbilities:[ {type:'shield', every:8000, duration:3500, reduction:0.9}, {type:'secondWind', threshold:0.2, healFrac:0.25} ],
      bossVariants:[
  ...
  var BESTIARY = {
    ...
    crystalGolem: { lore:"Formed from the cave's own crystal veins, humming with cold light.", power:"Raises a damage-reducing shield, and cracks into a rage that turns aside clean hits." },
    ...
    dragon: { lore:"The Warren's oldest and cruelest resident, said to have outlived three eras of hunters.", power:"Shields itself, and catches a second wind for one big burst of healing once badly wounded." },
...
sprig: { lore:"A wandering offshoot of something larger, still learning to walk.", power:"No special power." },
    ...
    hollowKing: { lore:"What the Hollow used to worship, before it forgot the difference between king and root.", power:"Exposes a weak point worth striking, then curses you until enough clicks break it." },
    ...
    abyssalWarden: { lore:"Posted here so long ago that no one, including it, remembers what it was guarding.", power:"Regenerates when badly hurt, and fades clean out of sight for a moment." },
    ...
    frostWarden: { lore:"Carved from the mountain to keep something else from getting out -- or in.", power:"Chills the air to blunt your strikes, and calls Rime Spiders down from the ledges." },
    ...
    forgottenKing: { lore:"Crowned himself long after anyone was left to object.", power:"Commands Animated Armor to his defense, and binds you with an old curse until you click free." },
    ...
    cinderBaron: { lore:"Claims to have ruled this valley since before it had lava in it.", power:"Drains the heat of your own strikes to mend itself, and calls Cinder Hounds to run interference." },
    ...
    fenWitch: { lore:"Every path through the Fen leads back to her hut eventually.", power:"Dances out of reach so strikes often miss, and tilts the odds into a gamble of double or half damage." },
    ...
    stormHerald: { lore:"Announces every storm on the Peak before it arrives -- including its own.", power:"Calls down Thunder Hawks, and channels a ritual that heals it big if you let it finish." },
